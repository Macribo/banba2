...
export class Champions extends React.Component {
	...
	render() {
		...
		term of endearment`,
			...
			`g. -leadh and -lidh, pl. -lidh, -leadha and -lidhe, gpl. fileadh, m., a poet, a professor (nom.
			also fileadh.).`,
		...
		return (
			<div className="champions">
				<div className="container champ-container" >
					{this.props.engMode ? <h1>Select Champion</h1> : <h1 alt="Champion">RoghnaighTuairghneach</h1>}
					<div id="bg2"></div>
					<div id="characters">
