...
Am cain lubai...</span>
`,
    `<span style=" font-family:aonchlo;font-weight: 900;">Am torc ar gail<br/>
Am he i l-lind<br/>
Am loch i m-maig...</span>`
    ,
...
<h5 > *Geburt des Liedes </h5>
  ...
  Ich bin die schönste aller Pflanzen</h5>`,
    ...
    `<h5>Ich bin ein Wildschwein in Tapferkeit<br/>
  Ich bin ein Lachs im Wasser<br/>
  Ich bin ein See in der Ebene</h5>`
...
<h6>Eine Warteschlange des gegenwärtigen Staates Irland</h6>`
    ...
    `,
    `Aber was ist mit dem Herzen, wenn die Zunge gälisch ist?
